        ...
        return (
            <div className="flex justify-center bg-black mt-[30px] pb-[20px]">
                <div className="flex flex-col text-center mt-[30px]">
                    <img
                        src="/images/postpagebg.svg"
                        alt=""
                        draggable={false}
                        className="w-[525px] h-[525px]"
                    />
                    <p className="text-white text-[20px] font-semibold mt-[10px]">
                        {t("noPosts")}
                    </p>
                </div>
            </div>
    ...
    return (
        <div className="grid grid-cols-4 mt-[30px] gap-4">
            {posts.map((post) => (
                <div
                    key={post.id}
                    className="relative max-w-[400px] rounded-[8px] cursor-pointer"
                >
                    <span className="w-full h-full rounded-[6px] flex flex-col justify-between p-[20px] bg-black text-white hover:translate-x-[-0.3rem] hover:translate-y-[-0.3rem] transition-all duration-150 ease-in-out">
                        ...
                        <div className="flex flex-col justify-between min-h-[140px]">
                            ...
                            <div className="flex items-center justify-between mt-[10px]">
                                ...
                                <div className="flex items-center gap-2">
                                    <EditDialog post={post} onUpdate={handleUpdatePost} />
                                    <Button
                    ...
                    <span className="absolute inset-0 bg-gray-200 rounded-[8px] z-[-1] transition-all duration-150 ease-in-out group-hover:translate-x-0 group-hover:translate-y-0" />
                </div>
            ))}
        </div>
    );
